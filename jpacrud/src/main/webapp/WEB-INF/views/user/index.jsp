						...
						<div class="carousel-content">
							...
							<div class="carousel-tag">
								<span class="badge badge-pill badge-primary"> English</span> <span
									...
									<button type="button" id="btn3">click em đi</button>
							</div>
						</div>
						<div class="carousel-btn-play">
							<a href="/pages/watch&read1.html" alt="play-button"> <img
								src="assets/Buttons-Play.svg" alt="playbuttonicon" />
							</a>
						</div>
					</div>
				</div>
		...
		<div class="row" style="align-items: flex-end;">
			<div class="col-lg">
				<div class="card card-left">
					...
					<img class="card-img" src="<c:url value="/web/assets/images/posteronepunchman.jpg"/>" alt="Card image cap">
					...
					<div class="card-body">
						<div class="card-first">
							<h5 class="card-title">${lstcommic[0].name}</h5>
							<c:url var="test"  value="/truyen">
							<c:param name="id">${lstcommic[0].id}</c:param>
							<c:param name="name">chap1</c:param>
							</c:url>
							<a href="${test }" class="btn btn-secondary btn-sm">Đọc</a>
						</div>
